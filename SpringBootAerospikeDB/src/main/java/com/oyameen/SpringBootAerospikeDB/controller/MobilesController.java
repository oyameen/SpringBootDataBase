package com.oyameen.SpringBootAerospikeDB.controller;
...
public class MobilesController {
    ...
    public ResponseEntity<Mobile> getMobile(@PathVariable("id") String id) {
    ...
    public ResponseEntity<Mobile> deleteMobile(@PathVariable("id") String id) {

package com.oyameen.SpringBootMongoDB.utils;

import com.oyameen.SpringBootMongoDB.model.*;
import com.oyameen.SpringBootMongoDB.repository.*;
...
public class DataBaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        project1.setEmployees(Collections.singletonList(employee));
        ...
        project2.setEmployees(Collections.singletonList(employee));
